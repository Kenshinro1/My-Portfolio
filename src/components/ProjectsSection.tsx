...
export default function ProjectsSection(): JSX.Element {
  return (
    <section id="projects" className="min-h-screen bg-gray-900 text-white p-10">
            ...
            <div className="p-6">
              ...
              {project.link && (
                <AnimatedButton
                  ...
                  download={project.type === "download" ? true : undefined}
                >
                  {project.type === "download" ? "Download Game" : "View Project"}
                </AnimatedButton>
              )}
            </div>
          </motion.div>
